...
public class StepImplementation extends BaseTest {
    ...
    @Step("<id> İd'li element ve <id> İd'li element <text> değerini içeriyor mu kontrol et")
    public void ControltoElementByid2(String id,String id2,String text) {
        MobileElement element = appiumDriver.findElement(By.id(id));
        MobileElement element2 = appiumDriver.findElement(By.id(id2));
        System.out.println("Alınan elementın text değeri " + element.getText());
        System.out.println("Alınan elementın text değeri " + element2.getText());
        Assert.assertTrue("Verilen text değeri ile alınan text değeri eşit değil", element.getText().equals(text));
        Assert.assertTrue("Verilen text değeri ile alınan text değeri eşit değil", element2.getText().equals(text));
